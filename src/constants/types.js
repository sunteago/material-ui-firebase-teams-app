...
export const FETCH_INITIAL_DATA_START = "FETCH_USER_DATA_START";
export const FETCH_INITIAL_DATA_SUCCESS = "FETCH_USER_DATA_SUCCESS";
export const FETCH_INITIAL_DATA_FAILED = "FETCH_USER_DATA_FAILED";
